...
class AdminManager {
    ...
    openOrderModal(orderId) {
        ...
        `).join('') : '<div class="order-detail-item"><span>Нет товаров</span></div>';
        ...
        document.getElementById('orderDetails').innerHTML = `
            ...
            <div class="order-detail-item">
                ...
                <span class="order-detail-value">${order.userName || 'Клиент'}</span>
            </div>
            <div class="order-detail-item">
                <span class="order-detail-label">Телефон:</span>
                <span class="order-detail-value">${order.userPhone || 'Не указан'}</span>
            </div>
            <div class="order-detail-item">
                <span class="order-detail-label">Адрес:</span>
                <span class="order-detail-value">${order.address || 'Не указан'}</span>
            </div>
            <div class="order-detail-item">
        ...
        document.getElementById('updateOrderBtn').onclick = () => {
            ...
            this.renderOrdersTable();
            this.renderDashboard();
            UI.showNotification('Заказ обновлен');
        };
    }
